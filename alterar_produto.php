     ...
     <?php if($usuario): ?>
       ...
       <form action="processa_alteracao_produto.php" method="POST">
          <input type="hidden" name="id_produto" 
           ...
           value="<?= htmlspecialchars($usuario['nome_prod']) ?>" required minlength="5" title="O nome deve possuir + de 5 letras">

           <label for="descricao">Descrição:</label>
           <input type="text" id="descricao "name="descricao" 
           value="<?= htmlspecialchars($usuario['descricao']) ?>" required minlength="5" title="O nome deve possuir + de 5 letras">

           <label for="qtde">Quantidade:</label>
           <input type="number" class="numero" id="qtde "name="qtde" 
           value="<?= htmlspecialchars($usuario['qtde']) ?>">

           <label for="valor_unit">Valor Unitário:</label>
           <input type="number" class="numero" id="valor_unit "name="valor_unit" 
           value="<?= htmlspecialchars($usuario['valor_unit']) ?>">
<br>
